...
var jwt_auth_guard_1 = require("../auth/jwt-auth.guard"); // Adjust the path as needed
var TasksController = function () {
    ...
    var TasksController = _classThis = /** @class */ (function () {
        ...
        TasksController_1.prototype.getAllTasks = function () {
    ...
    (function () {
        ...
        _getAllTasks_decorators = [(0, common_1.Get)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
