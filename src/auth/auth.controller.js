        ...
        AuthController_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // Pass the whole loginDto object to the service method
                    return [2 /*return*/, this.authService.login(loginDto)]; // This will pass { username, password } as a single object
                });
            });
        };
